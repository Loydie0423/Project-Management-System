                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item breadcrumb-item-primary"><a style="color: #007BFF">Project</a></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
            ...
            <div class="container-fluid">
                <div class="card shadow-lg px-4 py-5">
                    <div class="row">
                        ...
                        <div class="col-12 my-2">
                            <a class="btn btn-dark" href="{{ route('admin.project.create') }}">Add Project</a>
                        </div>
                        <div class="col-12 my-2">
